$(document).ready(function(){
	...
	var hand = {
		...
		sumCardTotal: function()
		{
			...
			$("#hdrTotal").html("分数: " + this.current_total );
			
			if(this.current_total > 21)
			{
				$("#btnStick").trigger("click");
				$("#imgResult").attr('src','images/x2.png');
				$("#hdrResult").html("你输了!这很正常没人能在我的网页里打败我！")
							   .attr('class', 'lose');
			}
			else if(this.current_total == 21)
			{
				...
				$("#hdrResult").html("恭喜你打出了21点!")
							   .attr('class', 'win');
				alert("你赢了，神龙通过谷歌浏览器发来贺电，然后你获得了一个神秘链接");
				$("#mylink").show();
			}
			else if(this.current_total <= 21 && this.cards.length == 5)
			{
				$("#btnStick").trigger("click");
				$("#imgResult").attr('src','images/check.png');
				$("#hdrResult").html("恭喜你打出了五小")
							   .attr('class', 'win');
				alert("你赢了，你成功召唤出了神龙，神龙给了你一个神秘链接");
				$("#mylink").show();
			}
		}
	};
	...
	$("#game").click( function(){
		alert("当点数等于21点或者打出5张小于21的牌时胜利");
		alert("胜利者将会召唤出一个新的游戏");
	});
